...
class _TeacherDashboardScreenState extends ConsumerState<TeacherDashboardScreen>
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.school, color: Colors.white, size: 32.w),
        ],
      ),
    );
  }
  ...
  Widget _buildQuickStats() {
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            child: _buildStatCard('الطلاب', '25', Icons.people, Colors.blue),
          ),
          SizedBox(width: 12.w),
          Expanded(
          ...
          SizedBox(width: 12.w),
          Expanded(
            child: _buildStatCard('التقييمات', '8', Icons.quiz, Colors.orange),
          ),
          SizedBox(width: 12.w),
          Expanded(
            child: _buildStatCard(
  ...
  Widget _buildClassroomsList() {
    ...
    return Column(
      children: classrooms
          .map((classroom) => _buildClassroomCard(classroom))
          .toList(),
    );
  }
  ...
  Widget _buildActivitiesList() {
    ...
    return Column(
      children: activities
          .map((activity) => _buildActivityListCard(activity))
          .toList(),
    );
  }
  ...
  Widget _buildStudentCard(Map<String, dynamic> student) {
    return Container(
      ...
      child: Row(
        children: [
          Text(student['avatar'] as String, style: TextStyle(fontSize: 32.sp)),
          SizedBox(width: 12.w),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                LinearProgressIndicator(
                  value: student['progress'] / 100 as double,
                  backgroundColor: Colors.grey[300],
                  valueColor: AlwaysStoppedAnimation<Color>(
                    student['progress'] as double > 80
                        ? Colors.green
                        : Colors.orange,
                  ),
                ),
          ...
          SizedBox(width: 12.w),
          Text(
            '${student['progress'] as double}%',
            style: TextStyle(
              fontSize: 14.sp,
              fontWeight: FontWeight.bold,
              color: student['progress'] as double > 80
                  ? Colors.green
                  : Colors.orange,
            ),
          ),
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              ScaffoldMessenger.of(
                context,
              ).showSnackBar(SnackBar(content: Text('عرض ${report['title']}')));
            },
            style: ElevatedButton.styleFrom(
  ...
  Widget _buildBottomNavigation() {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.assignment), label: 'الأنشطة'),
